...
The merge command uses intelligent deduplication to combine packages from multiple SBOMs:

### CPE-Based Deduplication
- **Primary Strategy**: Uses Common Platform Enumeration (CPE) as the canonical identifier
